          ...
          <div className={styles.contentSection}>
            <div className={styles.sectionHeader}>
              ...
              <a href="#" className={styles.viewMore}>
                Xem thêm
                <Icon icon="weui:arrow-outlined" className={styles.moreIcon} />
              </a>
            </div>
            ...
            <div className={styles.subCard}>
              ...
              <div className={styles.toolsWrapper}>
                ...
                <div className={styles.tool}>
                  ...
                  <div className={styles.toolTitle}>Chương Trình Của Shop</div>
                  <div className={styles.toolDesc}>
                ...
                <div className={styles.tool}>
                  ...
                  <div className={styles.toolDesc}>
                    Tạo Combo Khuyến Mãi để tăng giá trị đơn hàng trên mỗi người
                    mua
                  </div>
                </div>
                <div className={styles.tool}>
                ...
                <div className={styles.tool}>
                  ...
                  <div className={styles.toolDesc}>
                    Khuyến khích người mua theo dõi Shop bằng cách tặng voucher
                    cho Người theo dõi mới
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className={styles.subContent}>
          ...
          <div className={styles.subContentSection}>
            ...
            <div className={styles.newsWrapper}>
              ...
              <p className={styles.desc}>
                Chương trình GreenFood KOL Sellers - Người bán kinh nghiệm đang
                tìm kiếm thêm những người bán kinh nghiệm.. Tìm hiểu về chương
                trình ngay TẠI ĐÂY.
              </p>
            </div>
            <div className={styles.newsWrapper}>
              ...
              <p className={styles.desc}>
                Đừng bỏ lỡ tính năng Tối Đa Doanh Thu Quảng Cáo vì: Tính năng sẽ
                giúp bạn cải thiện ROAS như mong muốn. Tính năng sẽ giúp bạn
                tăng lưu lượng truy cập. Tính năng sẽ giúp bạn tăng nhận diện
                thương hiệu sản phẩm. TRẢI NGHIỆM NGAY!
              </p>
            </div>
            <div className={styles.newsWrapper}>
              <p className={styles.news}>
          ...
          <div className={styles.subContentSection}>
            ...
            <div className={styles.mission}>
              <p className={styles.missionTitle}>Hoàn thành khoá học bắt đầu</p>
