          ...
          <div className={styles.mainContent}>
            ...
            <div className={styles.content}>
                ...
                <div className={styles.subCard}>
                  ...
                  <div className={styles.toolsWrapper}>
                    ...
                    <div className={styles.tool}>
                      ...
                      <div className={styles.toolDesc}>
                        Công cụ tăng đơn hàng bằng cách tạo chương trình giảm
                        giá
                      </div>
                    </div>
                    <div className={styles.tool}>
                    ...
                    <div className={styles.tool}>
                      ...
                      <div className={styles.toolDesc}>
                        Công cụ giúp tăng doanh số bằng cách tạo khuyến mãi
                        khủng trong các khung giờ nhất định
                      </div>
                    </div>
                    <div className={styles.tool}>
                      <div className={styles.toolIcon}>
              ...
              <div className={styles.contentSection}>
                ...
                <p className={styles.subTitle}>
                  Bảng Hiệu Quả Hoạt Động giúp Người Bán hiểu rõ hơn về hoạt
                  động buôn bán của Shop mình dựa trên những chỉ tiêu sau:
                </p>
                <Tabs />
              </div>
              <div className={styles.contentSection}>
                ...
                <p className={styles.subTitle}>
                  Hệ thống Sao Quả Tạ giúp Người bán duy trì dịch vụ bán hàng
                  chất lượng, mang đến sự hài lòng cho Người mua.
                </p>
                <div className={styles.pointWrapper}>
                  <div className={styles.point}>0</div>
                  <div className={styles.pointDesc}>
                    Shop đang hoạt động rất hiệu quả, hãy giữ vững kết quả này
                    để Người mua thêm vững lòng tin Shop nhé!
                  </div>
                </div>
              </div>
            </div>
            <div className={styles.subContent}>
              ...
              <div className={styles.subContentSection}>
                ...
                <div className={styles.newsWrapper}>
                  ...
                  <p className={styles.desc}>
                    Đừng bỏ lỡ tính năng Tối Đa Doanh Thu Quảng Cáo vì: Tính
                    năng sẽ giúp bạn cải thiện ROAS như mong muốn. Tính năng sẽ
                    giúp bạn tăng lưu lượng truy cập. Tính năng sẽ giúp bạn tăng
                    nhận diện thương hiệu sản phẩm. TRẢI NGHIỆM NGAY!
                  </p>
                </div>
                <div className={styles.newsWrapper}>
                  <p className={styles.news}>
                  ...
                  <p className={styles.desc}>
                    ...
                    không cần tốn nhiều sức với tính năng Giá Thầu Cạnh Cạnh
                    Tranh .TRẢI NGHIỆM NGAY!
                  </p>
                </div>
              </div>
              <div className={styles.subContentSection}>
