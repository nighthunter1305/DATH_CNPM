            ...
            <div className="about-footer__container">
                <div className="footer-logo">
                    <div className="logoandcontact">
                        ...
                        <div className="about-footer-contact" style={{display: 'flex', gap: '15px', fontSize: '24px'}}>
                ...
                <div className="footer-bottom">
                    <p>Copyright © 2024 GreenFood. Trademarks belong to their respective owners. All rights
                        reserved.</p>
