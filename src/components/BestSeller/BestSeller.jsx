...
const BestSelling = ({ products = [] }) => {
  ...
  // Create rows of products, each row containing `productsPerRow` items
    ...
    <div className="best-sellers-carousel">
      ...
      <div className="product-container">
        ...
        {productRows.map((row, rowIndex) => (
          ...
          >
            {/* For each row, map through the products */}
            {Array.isArray(row) && row.map((product) => (
              <div
                key={product.id}
