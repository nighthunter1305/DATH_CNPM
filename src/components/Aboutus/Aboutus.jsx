        ...
        <>
            ...
            <div className="image-company">
                <img
                    ...
                    alt="big-image" className="big-image-company"/>
            ...
            <div className="about-content">
                <span className="slogan">Chúng tôi có mặt ở khắp các tỉnh thành của Việt Nam</span>
                ...
                <div className="oustanding-detail">
                    <h4 className="rate-detail">GreenFood là web bán hàng nằm trong top 10</h4>
                    ...
                    <h4 className="rate-detail">Là số tiền người mua trong cả nước tiết kiệm trong một năm nhờ vào GreenFood</h4>
                </div>
                ...
                <ul  className="departments-list">
                    ...
                    <li  className="departments-item ">
                        <div  className="title"> Business Intelligence and Data Analytics</div>
